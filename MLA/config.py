...
D_C = D_MODEL // 4  # KV compression dimension
D_PRIME_C = D_MODEL // 4  # Query compression dimension
D_R_H = 16  # RoPE component dimension
...
SCHEDULER_TYPE = "cosine"  # Options: "cosine", "sgdr", "sgd", "plateau"
